...
If B genuinely depends on unmerged A: branch B from A, open B's PR against A's
branch as its base, and say so in the description. Do not wait, and do not
merge them into one giant PR.
